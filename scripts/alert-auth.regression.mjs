...
test('signed alert tokens verify and expose only their identity metadata', async () => {
  const token = await createAlertToken('12345678-1234-1234-1234-123456789012', 1700000000000, 'test-secret')
  assert.deepEqual(await verifyAlertToken(token, 'test-secret', 1700000001000), { id: '12345678-1234-1234-1234-123456789012', createdAt: 1700000000000 })

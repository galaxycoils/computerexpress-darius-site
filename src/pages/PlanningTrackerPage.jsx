        ...
        <section className="results-section" aria-label="Planning notices">
          <div className="results-header">
            ...
            <p className="results-hint">
              Data sourced from{' '}
              <a href="https://www.stcatharines.ca" target="_blank" rel="noopener noreferrer">stcatharines.ca</a>,{' '}
          ...
          {filteredNotices.length === 0 && (
            <div className="no-results">
              ...
              <button className="button button-primary" onClick={() => { setSearch(''); setMunicipalityFilter('all'); setCategoryFilter('all'); setStatusFilter('all') }}>
                Clear all filters
              </button>
            </div>
          )}

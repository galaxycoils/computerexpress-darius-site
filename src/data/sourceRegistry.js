 ...
 *
 * Niagara Region news releases are hosted via Campaign Monitor (off-origin).
 * The public notices index is same-origin and scrapable.
 */
export const sourceRegistry = [
  ...
  { id: 'niagara-region-news', name: 'Niagara Region Public Notices', city: 'Niagara Region', kind: 'official-notice', url: 'https://www.niagararegion.ca/news/notices/default.aspx', enabled: true, reviewRequired: true },

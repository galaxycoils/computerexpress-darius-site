...
export const planningNotices = [
  ...
  {
    id: "stc-103-105-maple-st",
    municipality: "St. Catharines",
    type: "Minor Variance (Committee of Adjustment)",
    title: "103-105 Maple Street — Church-to-Residential Conversion Variances",
    description:
      "Variance A-53/26 to convert an existing church into a 20-unit residential building while retaining the 2-unit dwelling, with relief for landscaped open space, parking-area buffer, parking rate, and two-way drive aisle width.",
    fileNumber: "A-53/26",
    status: "Hearing Scheduled",
    meetingDate: "2026-10-14T17:00:00",
    meetingLocation: "Council Chambers, 50 Church St",
    ...
    tags: ["Minor Variance", "Maple Street", "Parking", "Adaptive Reuse"],
  },
  {
    id: "stc-2-ellis-ave",
    municipality: "St. Catharines",
    ...
    description:
      "Variance A-52/26 for two stacked townhouse blocks (48 units) seeking relief for front-yard garbage storage, landscape buffers, bicycle locker dimensions, interior side yard, platform setback, and an existing transformer in a landscape buffer.",
    fileNumber: "A-52/26",
    status: "Hearing Scheduled",
    meetingDate: "2026-10-14T17:00:00",
    meetingLocation: "Council Chambers, 50 Church St",
    ...
    category: "minor-variance",
    tags: ["Minor Variance", "Ellis Avenue", "Townhouse", "Parking"],
  },
  {
    id: "stc-5-louis-ave-psac",
    municipality: "St. Catharines",
    type: "Property Standards Appeal Hearing",
    title: "5 Louis Avenue — Property Standards Appeal",
    description:
      "Electronic Property Standards Committee hearing of an appeal from an August 19, 2026 Property Standards Officer order under the Building Code Act and Maintenance and Occupancy By-law 2014-248.",
    status: "Hearing Scheduled",
    meetingDate: "2026-10-15T17:00:00",
    meetingLocation: "Electronic hearing (live-streamed on City YouTube)",
    submissionDeadline: "2026-10-13T00:00:00",
    submissionEmail: "emunro@stcatharines.ca",
    publishedDate: "2026-09-22",
    sourceUrl:
  ...
  },
  {
    ...
    description:
      "City-initiated Official Plan amendment to adopt the Ontario Street Corridor Secondary Plan (QEW to Welland Ave, including 282 and 285 Ontario St).",
  ...
  },
  {
    ...
    description:
      "Variance to reduce minimum parking from 1.25 to 0.85 spaces/unit for 248 residential + 12 commercial units.",
    fileNumber: "A-20/26",
    ...
    publishedDate: "2026-08-25",
    sourceUrl:
      "https://www.stcatharines.ca/news/posts/notice-of-hearing-455-welland-avenue/",
    category: "minor-variance",
    tags: [
      "Minor Variance",
      "Parking",
  ...
  },
  {
    ...
    description:
      "Consent B-20/26SC to sever 293.13 sq m (12A Stepney St) for a semi-detached dwelling under construction; 293.14 sq m remnant retained for the second unit.",
    ...
    publishedDate: "2026-08-25",
    sourceUrl:
      "https://www.stcatharines.ca/news/posts/public-hearing-12-stepney-street/",
    category: "consent-application",
  ...
  },
  {
    ...
    description:
      "Variance A-51/26 to reduce front yard setback from 3 m to 2.3 m and increase maximum parking area width from 5.5 m to 6.0 m for a detached dwelling.",
    fileNumber: "A-51/26",
    status: "Hearing Complete",
    meetingDate: "2026-09-16T17:00:00",
    meetingLocation: "Council Chambers, 50 Church St",
    publishedDate: "2026-08-25",
    sourceUrl:
      "https://www.stcatharines.ca/news/posts/notice-of-hearing-60-thomas-street/",
    category: "minor-variance",
  ...
  },
  {
    ...
    description:
      "City-initiated site-specific CIP for long-term remediation and redevelopment of 282 Ontario St, 285 Ontario St, and 142 Queenston St.",
    status: "Meeting Complete",
    meetingDate: "2026-09-14T18:00:00",
    meetingLocation: "Council Chambers, 3rd Floor City Hall, 50 Church St",
    publishedDate: "2026-08-24",
    sourceUrl:
      "https://www.stcatharines.ca/news/posts/city-of-st-catharines-notice-of-public-meeting-community-improvement-plan-for-strategic-sites/",
  ...
  },
  {
    ...
    description:
      "Minor variance PLMV202600222 for two ground signs on the commercial property at 777-803 Niagara Street, each proposed at 10.5 m height (7.5 m maximum) and 34.6 sq m area (10 sq m maximum) under Sign By-law 2005-21.",
  ...
  },
  {
    ...
    description:
      "Consent applications to create new lots at 37-39 and 38-40 First Street for future multiple dwellings, with reciprocal access easements, plus variances to reduce required access aisle width from 6 m to 3 m on severed and retained lots.",
  ...
  },
  {
    ...
    description:
      "Sullivan Avenue and Towpath Street intersection closed Monday, September 21, 2026 at 6:00 a.m. for approximately two weeks while the contractor replaces aging underground infrastructure and reconstructs the roadway in downtown Thorold.",
    status: "Active",
  ...
  },
  {
    ...
    description:
      "City of Thorold PIC to gather resident feedback on proposed McMillan Park improvements. Project materials and comments also available on Let's Talk Thorold.",
  ...
  },
  {
    ...
    description:
      "Crompton Boulevard closed to through traffic from Richmond Street to the south end of Crompton Boulevard starting September 9, 2026 for construction. Bolton Avenue remains open through the intersection; Richmond Street and Queen Street remain open. Local access maintained where possible.",
    status: "Active",
    effectiveDate: "2026-09-09",
    publishedDate: "2026-09-02",
    sourceUrl:
      "https://www.thorold.ca/news/news/temporary-road-closure-crompton-blvd-starting-september-9/",
    engageUrl:
      "https://letstalk.thorold.ca/crompton-boulevard-bolton-avenue-cunningham-street-mccormack-drive",
    category: "road-closure",
  ...
  },
  {
    ...
    description:
      "Demar Construction to start Pamela Drive watermain replacement between Lawrence Drive and Sullivan Avenue. Work includes new watermain, valves, hydrants, service reconnections, and surface restoration. Pre-construction property surveys by Pre-Con Inspection Services precede construction.",
    status: "Pre-construction",
    publishedDate: "2026-09-03",
    sourceUrl:
      "https://www.thorold.ca/news/news/notice-of-project-commencement-pamela-drive-watermain-replacement/",

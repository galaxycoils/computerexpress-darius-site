...
function validateMessage(message) {
  if (!message || message.trim().length < 10) return 'Please share more details (at least 10 characters)'
  return ''
}
...
export default function ContactForm({ onSuccess }) {
  ...
  if (submitted) {
    return (
      <div className="contact-form contact-form-success">
        ...
        <h3>Message sent</h3>
        <p>Thanks for reaching out. We will get back to you within 1-2 business days with a custom audit and recommendations.</p>
      </div>
    )
  }
  ...
  return (
    <form ref={formRef} className="contact-form" onSubmit={handleSubmit} noValidate>
      ...
      <div className={`form-field ${touched.name && fieldErrors.name ? 'has-error' : ''}`}>
      ...
      <div className={`form-field ${touched.email && fieldErrors.email ? 'has-error' : ''}`}>
      ...
      <div className={`form-field ${touched.message && fieldErrors.message ? 'has-error' : ''}`}>

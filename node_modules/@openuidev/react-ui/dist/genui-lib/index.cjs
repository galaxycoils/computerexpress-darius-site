...
const Callout$1 = react.default.forwardRef((props, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		ref,
		className: (0, clsx.default)("openui-callout", variantMap$7[variant], duration && "openui-callout-autodismiss", className),
		style: dismissStyle,
		...rest,
...
const Callout = (0, _openuidev_react_lang.defineComponent)({
	name: "Callout",
	props: CalloutSchema,
...
const Card$1 = react.default.forwardRef((props, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		ref,
		className: (0, clsx.default)("openui-card", className, variantMap$6[variant], widthMap[width]),
		...rest,
		children
	});
});
...
const CardHeader = (0, _openuidev_react_lang.defineComponent)({
	name: "CardHeader",
...
const CodeBlock = (0, _openuidev_react_lang.defineComponent)({
	name: "CodeBlock",
...
const Image = (0, _openuidev_react_lang.defineComponent)({
	name: "Image",
	props: ImageSchema,
...
const ImageBlock = (0, _openuidev_react_lang.defineComponent)({
	name: "ImageBlock",
...
const ImageGallery = (0, _openuidev_react_lang.defineComponent)({
	name: "ImageGallery",
...
const MarkDownRenderer = (0, _openuidev_react_lang.defineComponent)({
...
const Separator = (0, _openuidev_react_lang.defineComponent)({
	name: "Separator",
...
const TextCallout$1 = react.default.forwardRef((props, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		ref,
		className: (0, clsx.default)("openui-text-callout", variantMap$5[variant], className),
		...rest,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
...
const TextCallout = (0, _openuidev_react_lang.defineComponent)({
	name: "TextCallout",
...
const TextContent = (0, _openuidev_react_lang.defineComponent)({
	name: "TextContent",
	...
	component: ({ props }) => {
		...
		return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
			...
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(MarkDownRenderer$1, { textMarkdown: props.text == null ? "" : String(props.text) })
		});
	}
});
//#endregion
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				}), index !== itemsToDisplay.length - 1 && separator && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Separator$1, { className: "openui-stacked-legend-separator" })] }, item.key))
			}),
...
const HorizontalBarChart = (0, _openuidev_react_lang.defineComponent)({
	...
	component: ({ props }) => {
		...
		return react.default.createElement(HorizontalBarChart$1, {
			data,
...
const RadarChart = (0, _openuidev_react_lang.defineComponent)({
	name: "RadarChart",
	...
	component: ({ props }) => {
		...
		const data = buildChartData(props.labels, props.series);
		if (!data.length) return null;
		return react.default.createElement(RadarChart$1, {
			data,
			categoryKey: "category",
			isAnimationActive: false
		});
...
const PieChart = (0, _openuidev_react_lang.defineComponent)({
	name: "PieChart",
	...
	component: ({ props }) => {
		...
		if (labels.length > 0 && values.length > 0) {
			...
			if (!data.length) return null;
			return react.default.createElement(PieChart$1, {
				data,
				categoryKey: "category",
				dataKey: "value",
				variant: props.variant,
		...
		if (sliceData.length) return react.default.createElement(PieChart$1, {
			data: sliceData,
			categoryKey: "category",
			dataKey: "value",
			variant: props.variant,
...
const RadialChart = (0, _openuidev_react_lang.defineComponent)({
	name: "RadialChart",
	...
	component: ({ props }) => {
		...
		if (labels.length > 0 && values.length > 0) {
			...
			if (!data.length) return null;
			return react.default.createElement(RadialChart$1, {
				data,
				categoryKey: "category",
				dataKey: "value",
				isAnimationActive: false
		...
		const sliceData = buildSliceData(props.labels);
		if (sliceData.length) return react.default.createElement(RadialChart$1, {
			data: sliceData,
			categoryKey: "category",
			dataKey: "value",
			isAnimationActive: false
...
const ScatterChart = (0, _openuidev_react_lang.defineComponent)({
	name: "ScatterChart",
	...
	component: ({ props }) => {
		...
		if (!data.length) return null;
		return react.default.createElement(ScatterChart$1, {
			data,
			xAxisDataKey: "x",
			yAxisDataKey: "y",
			isAnimationActive: false
...
const AreaChartCondensed = (0, _openuidev_react_lang.defineComponent)({
	name: "AreaChart",
	...
	component: ({ props }) => {
		...
		const data = buildChartData(props.labels, props.series);
		if (!data.length) return null;
		return react.default.createElement(AreaChartCondensed$1, {
			data,
			categoryKey: "category",
			variant: props.variant,
			xAxisLabel: props.xLabel,
...
const BarChartCondensed = (0, _openuidev_react_lang.defineComponent)({
	name: "BarChart",
	...
	component: ({ props }) => {
		...
		const data = buildChartData(props.labels, props.series);
		if (!data.length) return null;
		return react.default.createElement(BarChartCondensed$1, {
			data,
			categoryKey: "category",
			variant: props.variant,
			xAxisLabel: props.xLabel,
...
const LineChartCondensed = (0, _openuidev_react_lang.defineComponent)({
	name: "LineChart",
	...
	component: ({ props }) => {
		...
		const data = buildChartData(props.labels, props.series);
		if (!data.length) return null;
		return react.default.createElement(LineChartCondensed$1, {
			data,
			categoryKey: "category",
			variant: props.variant,
			xAxisLabel: props.xLabel,
...
const Table = (0, _openuidev_react_lang.defineComponent)({
	name: "Table",
...
const Tag$1 = (0, react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		ref,
		className: (0, clsx.default)("openui-tag", sizeMap$1[size], variantMap$4[variant], className),
		style: styles,
		...rest,
		children: [icon && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
...
const TagBlock = (0, _openuidev_react_lang.defineComponent)({
	name: "TagBlock",
	props: TagBlockSchema,
	description: "tags is an array of strings",
	component: ({ props }) => {
		return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TagBlock$1, { children: asArray(props.tags).map((tag, i) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Tag$1, { text: tag }, i)) });
	}
});
//#endregion
...
const Buttons$1 = (0, react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		ref,
		className: (0, clsx.default)("openui-buttons", variantMap$3[variant], className),
		style,
		...rest,
		children
	});
...
const Button = (0, _openuidev_react_lang.defineComponent)({
	name: "Button",
	props: ButtonSchema,
...
const Buttons = (0, _openuidev_react_lang.defineComponent)({
	name: "Buttons",
	props: ButtonsSchema,
...
const CheckBoxGroup$1 = react.default.forwardRef((props, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		ref,
		className: (0, clsx.default)("openui-checkbox-group", variantMap$1[variant], className),
		style,
		children
	});
});
...
const CheckBoxItem = (0, _openuidev_react_lang.defineComponent)({
	name: "CheckBoxItem",
	props: CheckBoxItemSchema,
	description: "",
	component: () => null
});
const CheckBoxGroup = (0, _openuidev_react_lang.defineComponent)({
	name: "CheckBoxGroup",
...
const SelectTrigger = (0, react.forwardRef)(({ className, style, children, hideDropdownIcon, size, ...props }, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_radix_ui_react_select.Trigger, {
		ref,
		className: (0, clsx.default)("openui-select-trigger", sizeMap[resolvedSize], className),
		style,
		...props,
...
const DatePicker = (0, _openuidev_react_lang.defineComponent)({
	name: "DatePicker",
...
const Input = (0, _openuidev_react_lang.defineComponent)({
	name: "Input",
	props: InputSchema,
	description: "",
	component: ({ props }) => {
...
const RadioGroup$1 = (0, react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_radio_group.Root, {
		ref,
		className: (0, clsx.default)("openui-radio-group", variants$1[variant], className),
		style,
		...rest,
		children
	});
...
const RadioItem = (0, _openuidev_react_lang.defineComponent)({
	name: "RadioItem",
	props: RadioItemSchema,
	description: "",
	component: () => null
});
const RadioGroup = (0, _openuidev_react_lang.defineComponent)({
	name: "RadioGroup",
...
const SelectItem = (0, _openuidev_react_lang.defineComponent)({
	name: "SelectItem",
	props: SelectItemSchema,
	description: "Option for Select",
	component: () => null
});
const Select = (0, _openuidev_react_lang.defineComponent)({
	name: "Select",
...
const Slider = (0, _openuidev_react_lang.defineComponent)({
	name: "Slider",
	props: SliderSchema,
...
const TextArea = (0, _openuidev_react_lang.defineComponent)({
	name: "TextArea",
...
const FormControl = (0, _openuidev_react_lang.defineComponent)({
	name: "FormControl",
...
const StepsItem = (0, _openuidev_react_lang.defineComponent)({
	name: "StepsItem",
	props: StepsItemSchema,
	description: "title and details text for one step",
	component: () => null
});
const Steps = (0, _openuidev_react_lang.defineComponent)({
	name: "Steps",
...
const FollowUpItem = (0, _openuidev_react_lang.defineComponent)({
	name: "FollowUpItem",
...
const FollowUpBlock = (0, _openuidev_react_lang.defineComponent)({
	name: "FollowUpBlock",
...
const ListItem = (0, _openuidev_react_lang.defineComponent)({
	name: "ListItem",
	props: zod_v4.z.object({
		title: zod_v4.z.string(),
		subtitle: zod_v4.z.string().optional(),
...
const ListBlock = (0, _openuidev_react_lang.defineComponent)({
	name: "ListBlock",
	props: zod_v4.z.object({
...
const FoldableSectionTrigger = (0, react.forwardRef)(({ className, style, text, ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_accordion.Header, {
	...
	children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_accordion.Trigger, {
		...
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Separator$1, { className: "openui-foldable-section-trigger-content-separator" }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
...
const Carousel = (0, _openuidev_react_lang.defineComponent)({
	name: "Carousel",
	props: zod_v4.z.object({
...
const Tabs = (0, _openuidev_react_lang.defineComponent)({
	name: "Tabs",
...
const Card = (0, _openuidev_react_lang.defineComponent)({
	name: "Card",
	props: CardSchema,
...
const Label = (0, _openuidev_react_lang.defineComponent)({
	name: "Label",
	props: LabelSchema,
...
const SwitchGroup$1 = (0, react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		ref,
		className: (0, clsx.default)("openui-switch-group", variants[variant], className),
		style,
		children
	});
});
...
const SwitchItem = (0, _openuidev_react_lang.defineComponent)({
	name: "SwitchItem",
	props: SwitchItemSchema,
	description: "Individual switch toggle",
	component: () => null
});
const SwitchGroup = (0, _openuidev_react_lang.defineComponent)({
	name: "SwitchGroup",
...
const Accordion$1 = (0, react.forwardRef)(({ className, style, variant = "clear", ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_accordion.Root, {
	ref,
	className: (0, clsx.default)("openui-accordion", variantMap[variant], className),
	style,
	...props
}));
...
const AccordionItem = (0, _openuidev_react_lang.defineComponent)({
	name: "AccordionItem",
	props: AccordionItemSchema,
	description: "value is unique id, trigger is section title",
	component: () => null
});
const Accordion = (0, _openuidev_react_lang.defineComponent)({
	name: "Accordion",
...
const Tag = (0, _openuidev_react_lang.defineComponent)({
	name: "Tag",
	props: TagSchema,
	description: "Styled tag/badge with optional icon and variant",
	component: ({ props }) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Tag$1, {
		text: props.text,
		size: props.size,
		variant: props.variant
	})

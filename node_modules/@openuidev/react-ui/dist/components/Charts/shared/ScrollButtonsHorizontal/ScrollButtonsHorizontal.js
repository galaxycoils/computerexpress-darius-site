...
export const ScrollButtonsHorizontal = React.memo(({ dataWidth, effectiveWidth, canScrollLeft, canScrollRight, isSideBarTooltipOpen, onScrollLeft, onScrollRight, }) => {
    ...
    return (_jsxs("div", { className: "openui-chart-horizontal-scroll-buttons-container", children: [_jsx(IconButton, { className: clsx("openui-chart-horizontal-scroll-button openui-chart-horizontal-scroll-button--left", {
                    "openui-chart-horizontal-scroll-button--disabled": !canScrollLeft,
                }), icon: _jsx(ChevronLeft, {}), variant: "secondary", onClick: onScrollLeft, size: "2-extra-small", disabled: !canScrollLeft, "aria-label": "Scroll left" }), _jsx(IconButton, { className: clsx("openui-chart-horizontal-scroll-button openui-chart-horizontal-scroll-button--right", {

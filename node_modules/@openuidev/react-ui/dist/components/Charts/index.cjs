...
tiny_invariant = require_chunk.__toESM(tiny_invariant);
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				}), index !== itemsToDisplay.length - 1 && separator && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_components_Separator_index.Separator, { className: "openui-stacked-legend-separator" })] }, item.key))
			}),
